...
const SeoReplies: React.FC<{ comments: comments; id: number }> = (props) => {
  ...
  return (
    <div className={classes.comment} key={comments.id}>
      <div className={classes.txtComment}>
        <p>{comments.comment}</p>
        {replyId !== comments.id && (
          <div
            className={classes.reply}
            onClick={() => replySelectedHandler(comments.id, comments.comment)}
          >
            <BsReplyFill />
          </div>
        )}
